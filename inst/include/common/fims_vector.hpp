...
public:
    ...
    /**
     * @brief Constructs a Vector using a std::initializer_list.
     */
    ...
    /**
     * @brief Sets the first element to scalar v.
     */
...
#ifdef FIMS_FULL_VECTOR_OPERATORS
    /**
     *@brief compound addition assignment of Vector.
     */
    ...
    /**
     *@brief compound addition assignment of scalar.
     */
    ...
    /**
     *@brief compound subtraction assignment of Vector.
     */
    Vector<Type>& operator-=(const Vector<Type>& v) {
    ...
    /**
     *@brief compound subtraction assignment of scalar.
     */
    Vector<Type>& operator-=(const Type& a) {
    ...
    /**
     *@brief compound multiplication assignment of Vector.
     */
    Vector<Type>& operator*=(const Vector<Type>& v) {
    ...
    /**
     *@brief compound multiplication assignment of scalar.
     */
    Vector<Type>& operator*=(const Type& a) {
    ...
    /**
     *@brief compound division assignment of Vector.
     */
    Vector<Type>& operator/=(const Vector<Type>& v) {
    ...
    /**
     *@brief compound division assignment of scalar.
     */
    Vector<Type>& operator/=(const Type& a) {
