...
This page provides information for following FIMS documentation. The documentation is associated with FIMS version `r FIMS_version`.
...
user_doc <- lapply(user_doc,'[', c("description", "link"))
...
developer_doc <- lapply(developer_doc,'[', c("description", "link", "update"))
...
project_manager_doc <- lapply(project_manager_doc,'[', c("description", "link", "update"))
